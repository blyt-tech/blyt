...
const char *strerror(int e) { (void)e; return "error"; }
...
blyt_time_t time(blyt_time_t *t) { if (t) *t = 0; return 0; }
...
typedef struct { int fd; } blyt_FILE;
...
size_t fread(void *b, size_t s, size_t n, void *f)
    { (void)b; (void)s; (void)n; (void)f; return 0; }
int   feof(void *f)                    { (void)f; return 1; }
...
int fprintf(void *f, const char *fmt, ...) {
    (void)f;
    if (blyt_console_debug) blyt_console_debug(fmt);
    return 0;
}
