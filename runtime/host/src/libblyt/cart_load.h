...
struct blyt_cart {
    ...
    char *id; /* .cart.info machine identifier (validated; never NULL) */
    char *title; /* .cart.info human-readable title (validated; never NULL) */
    char *version; /* .cart.info cart version string (validated; never NULL) */
